package com.kaboomroads.tehshadur.client.renderer.entity.player;
...
public class PlayerAnimation {
    public static final AnimationDefinition NECK_STRETCH = AnimationDefinition.Builder.withLength(2.0F)
